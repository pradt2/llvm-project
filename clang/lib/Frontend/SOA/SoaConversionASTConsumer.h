...
//
//class SoaConversionASTConsumer2 : public ASTConsumer, public RecursiveASTVisitor<SoaConversionASTConsumer2> {
//
//  CompilerInstance &CI;
//  Rewriter &R;
//
...
//
//public:
//  SoaConversionASTConsumer2(CompilerInstance &CI) : CI(CI), R(CI.getSourceManager().getRewriter()) {}
//
